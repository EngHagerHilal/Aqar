...
Route::group(['prefix' => 'admin'], function () {
      Route::get('/home',  function (){return redirect('admin/dashboard/');})->name('admin.home')->middleware('admin');
...
//dashboard
    ...
    Route::match(array('GET','POST'),'/posts/search/',  'admin\AdminController@searchPosts')->name('admin.search')->middleware('admin');
