...
@section('content')
    <div class=" login-container">
        <div class="container">
            @if(session('success'))
                <div class="alert alert-success py-5"> we have recived your message. Tank you </div>
            @endif
            @if(session('email_error'))
                <div class="alert alert-info py-5"> sorry error heppened we are working to fix it </div>
            @endif
